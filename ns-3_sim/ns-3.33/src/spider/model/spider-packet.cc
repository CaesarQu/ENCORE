...
NS_LOG_COMPONENT_DEFINE ("SpiderPacket");
...
TypeHeader::TypeHeader (MessageType t = SPIDERTYPE_HELLO)
  : m_type (t),
    m_valid (true)
{
}
...
{
  static TypeId tid = TypeId ("ns3::spider::TypeHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::spider::HelloHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::spider::PositionHeader")
    .SetParent<Header> ()
